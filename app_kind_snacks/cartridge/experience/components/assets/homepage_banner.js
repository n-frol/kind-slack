...
module.exports.render = function (context) {
    ...
    model.banner_height = content.banner_height ? 'height: ' + content.banner_height + ';': '';
    if (content.eyebrow) {
    ...
    if (content.subbutton) {
        model.subbutton = content.subbutton;
    }
    if (content.header_mobile) {
        model.header_mobile = content.header_mobile;
    } else {
        model.header_mobile = content.header;
    }
    if (content.copy) {
    ...
    if (content.button_border_color2) {
        model.button_color2_border = content.button_border_color2.value;
    }
    ...
    return new Template('experience/components/assets/homepage_banner2').render(model).text;
};
