...
'use strict';
/**
 * Transfer object for payment method credit direct capture
 */
...
var CreditCardCapture = AbstractRedirectPayment.extend({
    init: function () {
    ...
    getPaymentOperatorUrl: function () {
        return [
            ...
            this.getSitePreference('paymentOperatorCreditDirectCapturePath')
    ...
    getMACParams: function () {
        ...
        var captureAmount = this.customObject.custom.captureAmount;
        var amount = new Money(captureAmount, this.getCurrency());
...
module.exports = new CreditCardCapture();
