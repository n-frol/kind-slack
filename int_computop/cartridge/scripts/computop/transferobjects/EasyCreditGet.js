'use strict';
/**
 * Transfer object for payment method easyCredit get step (2)
 */
...
var EasyCreditGet = AbstractPayment.extend({
    init: function () {
     ...
     *
     * @returns {dw.util.HashMap} - hashmap with easycredit specific parameters
     */
    getCustomParams: function () {
        var map = new HashMap();
        map.put('EventToken', 'GET');
...
module.exports = new EasyCreditGet();
