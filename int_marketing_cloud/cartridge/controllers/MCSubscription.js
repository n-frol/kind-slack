 ...
 */
function submitAjax() {
    var form = server.forms.getForm('mcsubscribe');
    var errors = formErrors.getFormErrors(form);
    var subscribed = false;
    var noDecorator = false;
...
exports.SubscribeFooter = ensure(['get'], showSubscribeFooter);
...
exports.Submit = ensure(['post'], submit);

exports.SubmitAjax = ensure(['post'], submitAjax);
