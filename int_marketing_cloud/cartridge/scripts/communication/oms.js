 ...
 * @returns {SynchronousPromise}
 */
function partialShipment(promise, data) {
    return sendTrigger(hookPath + 'partialShipment', promise, data);
}

/**
 * Trigger a cancellation notification
 * @param {SynchronousPromise} promise
 * @param {module:communication/util/trigger~CustomerNotification} data
 * @returns {SynchronousPromise}
 */
 ...
 * @returns {SynchronousPromise}
 */
function refund(promise, data) {
    return sendTrigger(hookPath + 'refund', promise, data);
}
