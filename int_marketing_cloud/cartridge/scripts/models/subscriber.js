...
Subscriber.prototype = {
    ...
    _fetchSubscriber : function() {
        ...
        var buid = Site.current.getCustomPreferenceValue('mcMID');
        var req = webRef.RetrieveRequest();
        req.objectType = 'DataExtensionObject['+Site.current.getCustomPreferenceValue("mcWelcomeCouponDataExtensionExternalKey")+']';
        req.properties.add(['SubscriberFlag', "Email", "Status"]);
        req.clientIDs.push(buid);
        req.filter = filter;
