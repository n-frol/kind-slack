...
module.exports = [{
    ...
    output: {
        path: path.resolve('./app_kind_snacks/cartridge/static/default/css')
    },
    module: {
        rules: [{
            test: /\.scss$/,
    ...
    name: 'scss',
    entry: {
        'app': './app_kind_snacks_site/cartridge/client/default/scss/app.scss',
    },
    output: {
        path: path.resolve('./app_kind_snacks_site/cartridge/static/default/css')
    },
    module: {
        rules: [{
            test: /\.scss$/,
...
},
    {
        ...
        name: 'scss',
        entry: {
            'global': './app_kind_snacks_new/cartridge/client/default/scss/global.scss',
            'fullwidth': './app_kind_snacks_new/cartridge/client/default/scss/components/fullwidth.scss',
            'fullwidth2': './app_kind_snacks_new/cartridge/client/default/scss/components/fullwidth2.scss',
            'carousels': './app_kind_snacks_new/cartridge/client/default/scss/components/carousels.scss',
            'marque': './app_kind_snacks_new/cartridge/client/default/scss/components/marque.scss',
            'dual_product': './app_kind_snacks_new/cartridge/client/default/scss/components/dual_product.scss',
            'collection': './app_kind_snacks_new/cartridge/client/default/scss/components/collection.scss',
            'einstein': './app_kind_snacks_new/cartridge/client/default/scss/components/einstein.scss',
            'flyout_squares': './app_kind_snacks_new/cartridge/client/default/scss/components/flyout_squares.scss',
            'dynamic_introduction': './app_kind_snacks_new/cartridge/client/default/scss/components/dynamic_introduction.scss',
            'promotion_overlay': './app_kind_snacks_new/cartridge/client/default/scss/components/promotion_overlay.scss',
        },
        output: {
    ...
    },
    {
        ...
        name: 'scss',
        entry: {
            'global': './app_kind_snacks_new/cartridge/client/default/scss/globals/global.scss',
        },
        output: {
            path: path.resolve('./app_kind_snacks_new/cartridge/static/default/css/globals')
        },
        module: {
            rules: [{
                test: /\.scss$/,
