...
function retrieveSubscription(customerID, subscriptionID) {
	var service : Service = LocalServiceRegistry.createService("OrderGroove.RetrieveSubscription", {
		createRequest: function(svc : HTTPService, order, retry) {
            // HTTPS GET protocol with headers
            svc.URL = svc.URL + subscriptionID;
