...
var yotpoBottomLineSvc = LocalServiceRegistry.createService('int_yotpo_sfra_merge.https.get.bottomline.api', {
    ...
    getResponseLogMessage: function (response) {
        ...
        //responseJSON.response.bottomline.average_score;
        //responseJSON.response.bottomline.total_reviews;
        return JSON.stringify(responseJSON);
    }

});

exports.yotpoBottomLineSvc = yotpoBottomLineSvc;
