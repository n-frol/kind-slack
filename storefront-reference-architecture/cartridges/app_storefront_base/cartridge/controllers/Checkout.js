...
server.get(
    ...
    function (req, res, next) {
         ...
         * This event is tracked for AB test statistics but otherwise has no effect on the basket.
         * The system will register at most one checkout per basket per session.
         */
