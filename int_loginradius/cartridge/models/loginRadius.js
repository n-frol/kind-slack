...
function loginRadius(args) {
    ...
    this.src = !empty(site.getCustomPreferenceValue('loginRadiusSrc')) ?
        site.getCustomPreferenceValue('loginRadiusSrc') : 'https://auth.lrcontent.com/v2/js/LoginRadiusV2.js';
}
