...
/**
 *
 * @param {string} email - User requested email
 * @param {string} pass - User requested password
 * @param {string} fname - user first name
 * @param {string} lname - user last name
 * @returns {Object} - results of the api call
 */
function registerUser(email, pass, fname, lname) {
    var svc = getService();
    var res = svc.call({
        apiPath: 'identity/v2/manage/account',
        requestMethod: "POST",
